...
module.exports = async function () {
    ...
    const integrationsPromise = [
            ...
            "entities": {
              "asanaConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-asana-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/asana-connector\":\"7.47.8\",\"@fusebit-int/framework\":\"7.47.8\"}}"
                  },
              ...
              "asanaIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-asana-bot-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/asana-provider\":\"7.47.8\",\"@fusebit-int/framework\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
            ...
            "entities": {
              "confluenceConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-atlassian-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/atlassian-connector\":\"7.47.8\",\"@fusebit-int/framework\":\"7.47.8\"}}"
                  },
              ...
              "confluenceIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-atlassian-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/atlassian-provider\":\"7.47.8\",\"@fusebit-int/framework\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
            ...
            "entities": {
              "discordConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-discord-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/discord-connector\":\"7.47.8\",\"@fusebit-int/framework\":\"7.47.8\"}}"
                  },
              ...
              "discordIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-discord-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/discord-provider\":\"7.47.8\",\"@fusebit-int/framework\":\"7.47.8\",\"superagent\":\"^6.1.0\"},\"files\":[\"./integration.js\",\"README.md\"]}",
        ...
        },
        {
          ...
          "largeIcon": "<svg width=\"75\" height=\"57\" viewBox=\"0 0 75 57\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n<path d=\"M63.3057 4.72499C58.5394 2.538 53.4283 0.926718 48.0842 0.00387122C47.9869 -0.0139394 47.8897 0.0305704 47.8396 0.119592C47.1822 1.28872 46.4541 2.81395 45.9442 4.01277C40.1964 3.15226 34.478 3.15226 28.848 4.01277C28.338 2.7873 27.5834 1.28872 26.9232 0.119592C26.873 0.0335405 26.7758 -0.0109692 26.6785 0.00387122C21.3374 0.923769 16.2262 2.53505 11.457 4.72499C11.4157 4.74279 11.3803 4.77249 11.3568 4.81104C1.66199 19.2949 -0.993816 33.4227 0.309035 47.3753C0.31493 47.4436 0.353249 47.5089 0.406307 47.5504C6.80266 52.2477 12.9986 55.0994 19.0795 56.9896C19.1768 57.0193 19.2799 56.9837 19.3419 56.9036C20.7803 54.9392 22.0626 52.868 23.162 50.6898C23.2268 50.5623 23.1649 50.4109 23.0323 50.3605C20.9985 49.589 19.0618 48.6483 17.1989 47.5801C17.0516 47.494 17.0398 47.2833 17.1753 47.1824C17.5673 46.8886 17.9595 46.583 18.3338 46.2744C18.4015 46.218 18.4959 46.2061 18.5755 46.2417C30.814 51.8294 44.0636 51.8294 56.1577 46.2417C56.2373 46.2032 56.3317 46.2151 56.4024 46.2714C56.7768 46.58 57.1688 46.8886 57.5638 47.1824C57.6993 47.2833 57.6905 47.494 57.5431 47.5801C55.6802 48.6691 53.7436 49.589 51.7068 50.3575C51.5742 50.408 51.5152 50.5623 51.5801 50.6898C52.7031 52.8649 53.9853 54.9362 55.3972 56.9006C55.4562 56.9837 55.5623 57.0193 55.6596 56.9896C61.77 55.0994 67.9659 52.2477 74.3623 47.5504C74.4183 47.5089 74.4537 47.4465 74.4596 47.3783C76.0188 31.2475 71.8479 17.2355 63.403 4.81399C63.3823 4.77249 63.347 4.74279 63.3057 4.72499ZM24.9896 38.8796C21.305 38.8796 18.2689 35.4969 18.2689 31.3425C18.2689 27.1881 21.2461 23.8053 24.9896 23.8053C28.7625 23.8053 31.7691 27.2178 31.7101 31.3425C31.7101 35.4969 28.733 38.8796 24.9896 38.8796ZM49.838 38.8796C46.1535 38.8796 43.1175 35.4969 43.1175 31.3425C43.1175 27.1881 46.0945 23.8053 49.838 23.8053C53.611 23.8053 56.6175 27.2178 56.5587 31.3425C56.5587 35.4969 53.611 38.8796 49.838 38.8796Z\" fill=\"#5865F2\"/>\n</svg>\n",
          "version": "5.2.0",
          "description": "Use this integration template to register and handle Slash Commands for your Discord Bot!\n\n[Learn more](https://developer.fusebit.io/docs/discord-slash-commands)!\n",
          "parent": [
            "discord"
          ],
          "tags": {
          ...
          "resources": {
            "configureAppDocUrl": "https://developer.fusebit.io/docs/discord-slash-commands#creating-your-own-discord-slash-commands-app",
            "sampleConfig": {
              "isEnabled": false
            }
          },
            ...
            "entities": {
              "githubappConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-githubapp-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/githubapp-connector\":\"7.47.8\"}}"
                  },
              ...
              "githubappIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-githubapp-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/githubapp-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
            ...
            "entities": {
              "githuboauthConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-githuboauth-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/githuboauth-connector\":\"7.47.8\"}}"
                  },
              ...
              "githuboauthIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-github-oauth-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/githuboauth-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
            ...
            "entities": {
              "gitlabConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-gitlab-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/gitlab-connector\":\"7.47.8\"}}"
                  },
              ...
              "gitlabIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-gitlab-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/gitlab-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
            ...
            "entities": {
              "googleConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-google-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/google-connector\":\"7.47.8\"}}"
                  },
              ...
              "googleIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-google-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/google-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
        ...
        },
        {
          ...
          "resources": {
            "configureAppDocUrl": "https://developer.fusebit.io/docs/google-calendar#creating-your-own-google-calendar-app",
            "sampleConfig": {
              "isEnabled": true,
              "isGetEnabled": true,
              "isPostEnabled": true,
          ...
          "configuration": {
            ...
            "uischema": {
              ...
              "elements": [
                {
                  "type": "Control",
                  "scope": "#/properties/google-calendarIntegration/properties/id",
                  "label": "Name"
                },
                {
                  "type": "Control",
                ...
                {
                  "type": "Control",
                  "scope": "#/properties/google-calendarConnector/properties/id",
                  "label": "Google-calendar Connector name",
                  "rule": {
                    "effect": "SHOW",
                    "condition": {
                      "scope": "#/properties/ui/properties/toggle",
            ...
            "data": {
              "google-calendarConnector": {
                "google-calendarName": "google-calendar-connector"
              }
            },
            "entities": {
              "google-calendarConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-google-calendar-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/google-connector\":\"7.47.8\"}}"
                  },
                  "handler": "@fusebit-int/google-connector"
                },
                "id": "<% this.id %>",
              ...
              "google-calendarIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-google-calendar-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/google-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
                  ...
                  "components": [
                    {
                      ...
                      "skip": false,
                      "provider": "@fusebit-int/google-provider",
                      "entityId": "<% global.entities.google-calendarConnector.id %>",
                      "dependsOn": [],
                      "entityType": "connector"
                    }
                  ],
                ...
                "id": "<% this.id %>",
                "tags": {
                  "fusebit.service": "Google-calendar"
                }
              }
            }
          }
        },
        {
          "id": "google-docs",
          "name": "Google Docs",
\"stop-color:#508DF5;stop-opacity:0\"/><stop offset=\"1\" style=\"stop-color:#336FD6\"/></linearGradient><polygon fill=\"url(#SVGID_1_)\" points=\"51.77847,28.75683 81.25951,57.24623 81.25951,31.52179 \"/><path fill=\"#A6C5FA\" d=\"M57.40627,31.52205h23.85078L50.29913,1.06771v23.34718C50.29912,28.34006,53.4811,31.52204,57.40627,31.52205z\"/></g></g></g></svg>\n\n",
          "version": "5.2.0",
          "description": "Many of the features that make Google Docs so successful are available through this integration. It lets you read and write documents programmatically so that you can integrate data from various sources leveraging the power of Google Docs.\n\n[Learn more](https://developer.fusebit.io/docs/google-docs)!\n",
          "parent": [
            "google"
          ],
          "tags": {
          ...
          "resources": {
            "configureAppDocUrl": "https://developer.fusebit.io/docs/google-docs#creating-your-own-google-docs-app",
            "sampleConfig": {
              "isEnabled": false
            }
          },
          "configuration": {
            ...
            "uischema": {
              ...
              "elements": [
                {
                  "type": "Control",
                  "scope": "#/properties/google-docsIntegration/properties/id",
                  "label": "Name"
                },
                {
                  "type": "Control",
            ...
            "entities": {
              "googleConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-google-docs-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/google-connector\":\"7.47.8\"}}"
                  },
                  "handler": "@fusebit-int/google-connector"
                },
                "id": "<% this.id %>",
              ...
              "google-docsIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-google-docs-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/google-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
            ...
            "entities": {
              "googleConnector": {
                ...
                "data": {
                  "configuration": {
                    ...
                    "scope": "openid profile https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/drive.file",
                    "clientId": "<% global.consts.random %>",
                    "clientSecret": "<% global.consts.random %>",
                    "extraParams": "access_type=offline&prompt=consent",
                    "refreshErrorLimit": 100000,
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-google-drive-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/google-connector\":\"7.47.8\"}}"
                  },
                  "handler": "@fusebit-int/google-connector"
                },
                "id": "<% this.id %>",
              ...
              "google-driveIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-google-drive-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/google-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
        ...
        },
        {
          ...
          "resources": {
            "configureAppDocUrl": "https://developer.fusebit.io/docs/google gmail#creating-your-own-google-gmail-app",
            "sampleConfig": {
              "isEnabled": false
            }
          },
          "configuration": {
            ...
            "uischema": {
              ...
              "elements": [
                {
                  "type": "Control",
                  "scope": "#/properties/gmailIntegration/properties/id",
                  "label": "Name"
                },
                {
                  "type": "Control",
                ...
                {
                  "type": "Control",
                  "scope": "#/properties/gmailConnector/properties/id",
                  "label": "Google Gmail Connector name",
                  "rule": {
                    "effect": "SHOW",
                    "condition": {
                      "scope": "#/properties/ui/properties/toggle",
            ...
            "entities": {
              "gmailConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-google-gmail-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/google-connector\":\"7.47.8\"}}"
                  },
                  "handler": "@fusebit-int/google-connector"
                },
                "id": "<% this.id %>",
                  ...
                  "components": [
                    {
                      ...
                      "skip": false,
                      "provider": "@fusebit-int/google-provider",
                      "entityId": "<% global.entities.gmailConnector.id %>",
                      "dependsOn": [],
                      "entityType": "connector"
                    }
                  ],
        ...
        },
        {
          ...
          "private": true,
          "smallIcon": "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"64\" height=\"88\" viewBox=\"0 0 64 88\" style=\"enable-background:new 0 0 64 88;\">\n    <path fill=\"#0DC54C\" d=\"M58,88H6c-3.3,0-6-2.7-6-6V6c0-3.3,2.7-6,6-6h36l22,22v60C64,85.3,61.3,88,58,88z\"/>\n    <path fill=\"#08962D\" d=\"M42,0l22,22H42V0z\"/>\n    <path fill=\"#FDFFFF\" d=\"M12,34.5v28h40v-28H12z M17,39.5h12.5V46H17V39.5z M17,51h12.5v6.5H17V51z M47,57.5H34.5V51H47V57.5z M47,46H34.5v-6.5H47V46z\"/>\n</svg>\n",
          "largeIcon": "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"64\" height=\"88\" viewBox=\"0 0 64 88\" style=\"enable-background:new 0 0 64 88;\">\n    <path fill=\"#0DC54C\" d=\"M58,88H6c-3.3,0-6-2.7-6-6V6c0-3.3,2.7-6,6-6h36l22,22v60C64,85.3,61.3,88,58,88z\"/>\n    <path fill=\"#08962D\" d=\"M42,0l22,22H42V0z\"/>\n    <path fill=\"#FDFFFF\" d=\"M12,34.5v28h40v-28H12z M17,39.5h12.5V46H17V39.5z M17,51h12.5v6.5H17V51z M47,57.5H34.5V51H47V57.5z M47,46H34.5v-6.5H47V46z\"/>\n</svg>\n",
          "version": "5.2.0",
          "description": "This is a Google Sheets Add-On that allows you to get external data into Google Sheets with Node.js, NPM, and Fusebit Connectors. You can add this functionality into a Google Sheets spreadsheet by searching for \"Fusebit\" in the \nExtensions | Add-ons | Get add-ons gallery in Google Sheets. \n\n[Learn more](https://developer.fusebit.io/docs/google-sheets-addon)!\n",
          "tags": {
            ...
            "entities": {
              "customIntegration": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-google-sheets-add-on-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"superagent\":\"7.0.1\"},\"files\":[\"./integration.js\",\"README.md\"]}",
        ...
        {
          "id": "google-sheets-planned",
          "name": "Google Sheets",
          "smallIcon": "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"64\" height=\"88\" viewBox=\"0 0 64 88\" style=\"enable-background:new 0 0 64 88;\">\n    <path fill=\"#0DC54C\" d=\"M58,88H6c-3.3,0-6-2.7-6-6V6c0-3.3,2.7-6,6-6h36l22,22v60C64,85.3,61.3,88,58,88z\"/>\n    <path fill=\"#08962D\" d=\"M42,0l22,22H42V0z\"/>\n    <path fill=\"#FDFFFF\" d=\"M12,34.5v28h40v-28H12z M17,39.5h12.5V46H17V39.5z M17,51h12.5v6.5H17V51z M47,57.5H34.5V51H47V57.5z M47,46H34.5v-6.5H47V46z\"/>\n</svg>\n",
          "largeIcon": "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"64\" height=\"88\" viewBox=\"0 0 64 88\" style=\"enable-background:new 0 0 64 88;\">\n    <path fill=\"#0DC54C\" d=\"M58,88H6c-3.3,0-6-2.7-6-6V6c0-3.3,2.7-6,6-6h36l22,22v60C64,85.3,61.3,88,58,88z\"/>\n    <path fill=\"#08962D\" d=\"M42,0l22,22H42V0z\"/>\n    <path fill=\"#FDFFFF\" d=\"M12,34.5v28h40v-28H12z M17,39.5h12.5V46H17V39.5z M17,51h12.5v6.5H17V51z M47,57.5H34.5V51H47V57.5z M47,46H34.5v-6.5H47V46z\"/>\n</svg>\n",
          "version": "5.2.0",
          "description": "Many of the features that make Google Sheets so successful are available through this integration. It lets you read and write spreadsheets programmatically so that you can integrate data from various sources leveraging the power of Google Sheets.",
          "outOfPlan": true,
          "tags": {
            "catalog": "Project Management,Dev Tools,Office,Spreadsheets"
          },
          "configuration": {}
        },
        {
            ...
            "entities": {
              "hubspotConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-hubspot-crm-contacts-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/hubspot-connector\":\"7.47.8\"}}"
                  },
              ...
              "hubspotIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-hubspot-crm-contacts-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/hubspot-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
            ...
            "entities": {
              "hubspotSlackBotIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-e2e-hubspot-slack-bot-integration\",\"version\":\"7.47.8\",\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/hubspot-provider\":\"7.47.8\",\"@fusebit-int/slack-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
              ...
              "slackConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-slack-bot-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/slack-connector\":\"7.47.8\"}}"
                  },
        ...
        },
        {
          ...
          "largeIcon": "<svg width=\"57\" height=\"57\" viewBox=\"0 0 57 57\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n<path d=\"M49.4001 31.3384C49.3947 31.8388 49.1921 32.3168 48.8364 32.6687C48.4806 33.0206 48.0004 33.218 47.5 33.218C46.9996 33.218 46.5195 33.0206 46.1637 32.6687C45.808 32.3168 45.6054 31.8388 45.6 31.3384V14.25C45.6054 13.7496 45.808 13.2716 46.1637 12.9197C46.5195 12.5678 46.9996 12.3704 47.5 12.3704C48.0004 12.3704 48.4806 12.5678 48.8364 12.9197C49.1921 13.2716 49.3947 13.7496 49.4001 14.25V31.3384ZM48.737 43.2312C48.4433 43.4825 41.4049 49.3887 28.5 49.3887C15.5953 49.3887 8.55712 43.4823 8.26344 43.2309C7.88091 42.9029 7.64432 42.4364 7.6057 41.934C7.56707 41.4315 7.72958 40.9343 8.05748 40.5517C8.38468 40.1697 8.85005 39.9331 9.3515 39.8937C9.85294 39.8544 10.3495 40.0156 10.7323 40.342C10.8438 40.4355 17.1289 45.5884 28.5002 45.5884C40.0142 45.5884 46.2021 40.3983 46.2633 40.346C47.0584 39.6631 48.2601 39.7548 48.9425 40.5519C49.2705 40.9345 49.4331 41.4317 49.3946 41.9341C49.3561 42.4366 49.1195 42.9031 48.737 43.2312V43.2312ZM7.59993 14.25C7.60534 13.7496 7.80791 13.2716 8.16365 12.9197C8.51938 12.5678 8.99958 12.3704 9.49996 12.3704C10.0004 12.3704 10.4805 12.5678 10.8363 12.9197C11.192 13.2716 11.3946 13.7496 11.4 14.25V31.3384C11.3946 31.8388 11.192 32.3168 10.8363 32.6687C10.4805 33.0206 10.0004 33.218 9.49996 33.218C8.99958 33.218 8.51938 33.0206 8.16365 32.6687C7.80791 32.3168 7.60534 31.8388 7.59993 31.3384V14.25ZM17.1002 10.4499C17.1079 9.95107 17.3114 9.47523 17.6669 9.12516C18.0223 8.77509 18.5012 8.57887 19.0001 8.57887C19.4991 8.57887 19.978 8.77509 20.3334 9.12516C20.6889 9.47523 20.8924 9.95107 20.9001 10.4499V35.833C20.8924 36.3318 20.6889 36.8077 20.3334 37.1577C19.978 37.5078 19.4991 37.704 19.0001 37.704C18.5012 37.704 18.0223 37.5078 17.6669 37.1577C17.3114 36.8077 17.1079 36.3318 17.1002 35.833V10.4501V10.4499ZM26.6001 9.4885C26.6 9.23899 26.6492 8.99191 26.7446 8.76139C26.8401 8.53087 26.9801 8.32141 27.1565 8.14498C27.3329 7.96855 27.5424 7.8286 27.7729 7.73313C28.0034 7.63766 28.2505 7.58854 28.5 7.58857C28.7495 7.58851 28.9966 7.63761 29.2272 7.73307C29.4577 7.82853 29.6672 7.96847 29.8437 8.1449C30.0201 8.32134 30.1601 8.5308 30.2556 8.76134C30.351 8.99188 30.4002 9.23897 30.4001 9.4885V37.0384C30.3947 37.5388 30.1922 38.0168 29.8364 38.3687C29.4807 38.7206 29.0005 38.918 28.5001 38.918C27.9997 38.918 27.5195 38.7206 27.1638 38.3687C26.8081 38.0168 26.6055 37.5388 26.6001 37.0384V9.4885V9.4885ZM36.1001 10.4499C36.1078 9.95107 36.3113 9.47523 36.6668 9.12516C37.0223 8.77509 37.5012 8.57887 38.0001 8.57887C38.499 8.57887 38.9779 8.77509 39.3334 9.12516C39.6888 9.47523 39.8924 9.95107 39.9 10.4499V35.833C39.8924 36.3318 39.6888 36.8077 39.3334 37.1577C38.9779 37.5078 38.499 37.704 38.0001 37.704C37.5012 37.704 37.0223 37.5078 36.6668 37.1577C36.3113 36.8077 36.1078 36.3318 36.1001 35.833V10.4501V10.4499ZM49.875 0H7.125C3.19 0 0 3.19 0 7.125V49.875C0 53.8098 3.19 57 7.125 57H49.875C53.81 57 57 53.8098 57 49.875V7.125C57 3.19 53.81 0 49.875 0Z\" fill=\"#1F8DED\"/>\n</svg>\n",
          "version": "5.2.0",
          "description": "Use our Intercom Integration to retrieve and update information from your own Intercom account, or to integrate Intercom into your own product. It's completely up to you and your custom use case.",
          "outOfPlan": true,
          "tags": {
            ...
            "entities": {
              "jiraConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-jira-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/atlassian-connector\":\"7.47.8\",\"@fusebit-int/framework\":\"7.47.8\"}}"
                  },
                  "handler": "@fusebit-int/atlassian-connector"
                },
                "id": "<% this.id %>",
              ...
              "jiraIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-jira-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/atlassian-provider\":\"7.47.8\",\"@fusebit-int/framework\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
            ...
            "entities": {
              "linearConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-linear-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/linear-connector\":\"7.47.8\"}}"
                  },
              ...
              "linearIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-linear-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/linear-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
        ...
        {
          "id": "linear-discord-bot",
          "name": "Linear Discord Bot",
          "smallIcon": "<svg width=\"64\" height=\"64\" viewBox=\"0 0 64 64\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\" style=\"width:24px;height:24px;margin-right:12px\"><path d=\"M0.403013 37.3991L26.6009 63.597C13.2225 61.3356 2.66442 50.7775 0.403013 37.3991Z\" fill=\"#5E6AD2\"></path><path d=\"M0 30.2868L33.7132 64C35.7182 63.8929 37.6742 63.6013 39.5645 63.142L0.85799 24.4355C0.398679 26.3259 0.10713 28.2818 0 30.2868Z\" fill=\"#5E6AD2\"></path><path d=\"M2.53593 19.4042L44.5958 61.4641C46.1277 60.8066 47.598 60.0331 48.9956 59.1546L4.84543 15.0044C3.96691 16.402 3.19339 17.8723 2.53593 19.4042Z\" fill=\"#5E6AD2\"></path><path d=\"M7.69501 11.1447C13.5677 4.32093 22.2677 0 31.9769 0C49.6628 0 64 14.3372 64 32.0231C64 41.7323 59.6791 50.4323 52.8553 56.305L7.69501 11.1447Z\" fill=\"#5E6AD2\"></path></svg>\n\n",
          "largeIcon": "<svg width=\"64\" height=\"64\" viewBox=\"0 0 64 64\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\" style=\"width:24px;height:24px;margin-right:12px\"><path d=\"M0.403013 37.3991L26.6009 63.597C13.2225 61.3356 2.66442 50.7775 0.403013 37.3991Z\" fill=\"#5E6AD2\"></path><path d=\"M0 30.2868L33.7132 64C35.7182 63.8929 37.6742 63.6013 39.5645 63.142L0.85799 24.4355C0.398679 26.3259 0.10713 28.2818 0 30.2868Z\" fill=\"#5E6AD2\"></path><path d=\"M2.53593 19.4042L44.5958 61.4641C46.1277 60.8066 47.598 60.0331 48.9956 59.1546L4.84543 15.0044C3.96691 16.402 3.19339 17.8723 2.53593 19.4042Z\" fill=\"#5E6AD2\"></path><path d=\"M7.69501 11.1447C13.5677 4.32093 22.2677 0 31.9769 0C49.6628 0 64 14.3372 64 32.0231C64 41.7323 59.6791 50.4323 52.8553 56.305L7.69501 11.1447Z\" fill=\"#5E6AD2\"></path></svg>\n\n",
          "version": "5.2.0",
          "description": "This Integration lets you write a custom Discord bot for Linear which uses Slash Commands support to create new issues in your Linear project.\n\n[Learn more](https://developer.fusebit.io/docs/e2e-linear-discord-bot)!\n",
          "parent": [
            "linear",
            "discord"
          ],
            ...
            "entities": {
              "e2e-linear-discord-botIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-e2e-linear-discord-bot-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/discord-provider\":\"7.47.8\",\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/linear-provider\":\"7.47.8\",\"superagent\":\"^6.1.0\"},\"files\":[\"./integration.js\",\"README.md\"]}",
                    ...
                    "README.md": "This Integration lets you write a custom Discord bot for Linear which uses Slash Commands support to create new issues in your Linear project.\n\n[Learn more](https://developer.fusebit.io/docs/e2e-linear-discord-bot)!\n"
                  },
                  "handler": "./integration",
                  "components": [
                    {
        ...
        },
        {
          ...
          "version": "5.2.0",
          "private": true,
          "description": "Integrating with Linear-form is easy with Fusebit! This example lets you list Contacts in your customer's Linear-form instance.\n\n[Learn more](https://developer.fusebit.io/docs/linear-form)!\n",
          "parent": [
            "linear"
          ],
          "tags": {
            ...
            "entities": {
              "linearConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-linear-form-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/linear-connector\":\"7.47.8\"}}"
                  },
                  "handler": "@fusebit-int/linear-connector"
                },
                "id": "<% this.id %>",
            ...
            "entities": {
              "linkedinConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-linkedin-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/linkedin-connector\":\"7.47.8\"}}"
                  },
              ...
              "linkedinIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-linkedin-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/linkedin-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
        ...
        },
        {
          ...
          "resources": {
            ...
            "sampleConfig": {
              ...
              "isPostEnabled": false,
              "terms": {
                "getFail": "Oops! Something went wrong and we couldn't retrieve your audience list from Mailchimp",
                "itemName": "Audience",
                "properties": [
                  {
                    "name": "audienceName",
          ...
          "configuration": {
            ...
            "uischema": {
              ...
              "elements": [
                {
                  "type": "Control",
                  "scope": "#/properties/mailchimpIntegration/properties/id",
                  "label": "Name"
                },
                {
                  "type": "Control",
                ...
                {
                  "type": "Control",
                  "scope": "#/properties/mailchimpConnector/properties/id",
                  "label": "Mailchimp Connector name",
                  "rule": {
                    "effect": "SHOW",
                    "condition": {
                      "scope": "#/properties/ui/properties/toggle",
            ...
            "data": {
              "mailchimpConnector": {
                "mailchimpName": "mailchimp-connector"
              }
            },
            "entities": {
              "mailchimpConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-mailchimp-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/mailchimp-connector\":\"7.47.8\"}}"
                  },
                  "handler": "@fusebit-int/mailchimp-connector"
                },
                "id": "<% this.id %>",
                "tags": {
                  "fusebit.service": "Mailchimp"
                }
              },
              "mailchimpIntegration": {
                "entityType": "integration",
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-mailchimp-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/mailchimp-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
                  ...
                  "components": [
                    {
                      ...
                      "entityId": "<% global.entities.mailchimpConnector.id %>",
                      "dependsOn": [],
                      "entityType": "connector"
                    }
                  ],
        ...
        },
        {
          ...
          "largeIcon": "<svg width=\"62\" height=\"57\" viewBox=\"0 0 62 57\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n<g clip-path=\"url(#clip0_1279178)\">\n<path d=\"M38.4856 27.075L14.2539 22.8V54.388C14.2539 55.8306 15.4237 57 16.8667 57H58.6792C60.1222 57 61.292 55.8306 61.292 54.388V42.75L38.4856 27.075Z\" fill=\"#185C37\"/>\n<path d=\"M38.4856 0H16.8667C15.4237 0 14.2539 1.16944 14.2539 2.61202V14.25L38.4856 28.5L51.3142 32.775L61.292 28.5V14.25L38.4856 0Z\" fill=\"#21A366\"/>\n<path d=\"M14.2539 14.25H38.4856V28.5H14.2539V14.25Z\" fill=\"#107C41\"/>\n<path opacity=\"0.1\" d=\"M31.5967 11.4H14.2539V47.025H31.5967C33.0377 47.0203 34.2048 45.8536 34.2094 44.4129V14.012C34.2048 12.5714 33.0377 11.4046 31.5967 11.4Z\" fill=\"black\"/>\n<path opacity=\"0.2\" d=\"M30.1713 12.825H14.2539V48.45H30.1713C31.6123 48.4453 32.7794 47.2786 32.784 45.838V15.437C32.7794 13.9964 31.6123 12.8297 30.1713 12.825Z\" fill=\"black\"/>\n<path opacity=\"0.2\" d=\"M30.1713 12.825H14.2539V45.6H30.1713C31.6123 45.5953 32.7794 44.4286 32.784 42.988V15.437C32.7794 13.9964 31.6123 12.8297 30.1713 12.825Z\" fill=\"black\"/>\n<path opacity=\"0.2\" d=\"M28.7459 12.825H14.2539V45.6H28.7459C30.1869 45.5953 31.354 44.4286 31.3587 42.988V15.437C31.354 13.9964 30.1869 12.8297 28.7459 12.825Z\" fill=\"black\"/>\n<path d=\"M2.61274 12.825H28.7459C30.1889 12.825 31.3587 13.9944 31.3587 15.437V41.5629C31.3587 43.0055 30.1889 44.175 28.7459 44.175H2.61274C1.16976 44.175 0 43.0055 0 41.563V15.437C0 13.9944 1.16976 12.825 2.61274 12.825Z\" fill=\"url(#paint0_linear_1279178)\"/>\n<path d=\"M8.09192 36.9902L13.5882 28.4758L8.55233 20.0084H12.6033L15.3515 25.4234C15.6052 25.9378 15.7791 26.3197 15.8732 26.5719H15.9088C16.0893 26.1615 16.2794 25.763 16.4789 25.3764L19.4167 20.0113H23.1355L17.9713 28.4288L23.2667 36.9901H19.3098L16.1354 31.0465C15.9859 30.7936 15.859 30.528 15.7563 30.2528H15.7093C15.6163 30.5224 15.4929 30.7805 15.3415 31.0223L12.0731 36.9902H8.09192Z\" fill=\"white\"/>\n<path d=\"M58.6793 0H38.4857V14.25H61.292V2.61202C61.292 1.16944 60.1223 0 58.6793 0Z\" fill=\"#33C481\"/>\n<path d=\"M38.4857 28.5H61.292V42.75H38.4857V28.5Z\" fill=\"#107C41\"/>\n</g>\n<defs>\n<linearGradient id=\"paint0_linear_1279178\" x1=\"5.44764\" y1=\"10.784\" x2=\"25.9026\" y2=\"46.2209\" gradientUnits=\"userSpaceOnUse\">\n<stop stop-color=\"#18884F\"/>\n<stop offset=\"0.5\" stop-color=\"#117E43\"/>\n<stop offset=\"1\" stop-color=\"#0B6631\"/>\n</linearGradient>\n<clipPath id=\"clip0_1279178\">\n<rect width=\"61.292\" height=\"57\" fill=\"white\"/>\n</clipPath>\n</defs>\n</svg>\n",
          "version": "5.2.0",
          "description": "This Integration allows users to read and modify Excel workbooks, and easily work with objects\nsuch as tables, ranges, and charts. ",
          "outOfPlan": true,
          "tags": {
        ...
        },
        {
          ...
          "largeIcon": "<svg width=\"62\" height=\"57\" viewBox=\"0 0 62 57\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n<g clip-path=\"url(#clip0_1279153)\">\n<path d=\"M61.275 29.925C61.2784 29.4459 61.0308 28.9999 60.6224 28.7494H60.6152L60.5896 28.7351L39.3571 16.1666C39.2654 16.1047 39.1702 16.0481 39.0721 15.9971C38.2523 15.5741 37.2784 15.5741 36.4586 15.9971C36.3604 16.0481 36.2653 16.1047 36.1736 16.1666L14.9411 28.7351L14.9155 28.7494C14.2666 29.1529 14.0676 30.0061 14.4712 30.6551C14.5901 30.8463 14.7538 31.0056 14.9483 31.1191L36.1808 43.6876C36.2728 43.7491 36.3679 43.8057 36.4658 43.8572C37.2856 44.2802 38.2594 44.2802 39.0793 43.8572C39.1771 43.8057 39.2722 43.7491 39.3643 43.6876L60.5968 31.1191C61.0209 30.8718 61.2799 30.416 61.275 29.925Z\" fill=\"#0A2767\"/>\n<path d=\"M17.4163 21.5332H31.3499V34.3054H17.4163V21.5332ZM58.425 8.54999V2.70749C58.4584 1.24673 57.3022 0.0350031 55.8415 0H19.6835C18.2227 0.0350031 17.0665 1.24673 17.1 2.70749V8.54999L38.475 14.25L58.425 8.54999Z\" fill=\"#0364B8\"/>\n<path d=\"M17.1 8.54999H31.35V21.375H17.1V8.54999Z\" fill=\"#0078D4\"/>\n<path d=\"M45.6 8.54999H31.35V21.375L45.6 34.2H58.4249V21.375L45.6 8.54999Z\" fill=\"#28A8EA\"/>\n<path d=\"M31.35 21.375H45.5999V34.2H31.35V21.375Z\" fill=\"#0078D4\"/>\n<path d=\"M31.35 34.2H45.5999V47.0249H31.35V34.2Z\" fill=\"#0364B8\"/>\n<path d=\"M17.4163 34.3054H31.35V45.9163H17.4163V34.3054Z\" fill=\"#14447D\"/>\n<path d=\"M45.6 34.2H58.425
575 29.5087 11.3458 31.521L11.3444 31.5181Z\" fill=\"white\"/>\n<path d=\"M45.6 8.54999H58.425V21.375H45.6V8.54999Z\" fill=\"#50D9FF\"/>\n</g>\n<defs>\n<linearGradient id=\"paint0_linear_1279153\" x1=\"37.7625\" y1=\"29.925\" x2=\"37.7625\" y2=\"56.9999\" gradientUnits=\"userSpaceOnUse\">\n<stop stop-color=\"#35B8F1\"/>\n<stop offset=\"1\" stop-color=\"#28A8EA\"/>\n</linearGradient>\n<linearGradient id=\"paint1_linear_1279153\" x1=\"5.44613\" y1=\"10.784\" x2=\"25.9038\" y2=\"46.216\" gradientUnits=\"userSpaceOnUse\">\n<stop stop-color=\"#1784D9\"/>\n<stop offset=\"0.5\" stop-color=\"#107AD5\"/>\n<stop offset=\"1\" stop-color=\"#0A63C9\"/>\n</linearGradient>\n<clipPath id=\"clip0_1279153\">\n<rect width=\"61.275\" height=\"57\" fill=\"white\"/>\n</clipPath>\n</defs>\n</svg>\n",
          "version": "5.2.0",
          "description": "This Integration allows you to access user's mail, calendar, and contacts data on Outlook.com or Office 365. ",
          "outOfPlan": true,
          "tags": {
        ...
        },
        {
          ...
          "largeIcon": "<svg width=\"62\" height=\"57\" viewBox=\"0 0 62 57\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n<g clip-path=\"url(#clip0_1279209)\">\n<path d=\"M42.74 21.375H58.5675C60.0628 21.375 61.275 22.5872 61.275 24.0825V38.4992C61.275 43.9949 56.8199 48.45 51.3242 48.45H51.2772C45.7815 48.4508 41.3257 43.9963 41.325 38.5006C41.325 38.5002 41.325 38.4997 41.325 38.4992V22.79C41.325 22.0085 41.9585 21.375 42.74 21.375Z\" fill=\"#5059C9\"/>\n<path d=\"M53.4375 18.525C56.9791 18.525 59.85 15.654 59.85 12.1125C59.85 8.57096 56.9791 5.69998 53.4375 5.69998C49.896 5.69998 47.025 8.57096 47.025 12.1125C47.025 15.654 49.896 18.525 53.4375 18.525Z\" fill=\"#5059C9\"/>\n<path d=\"M33.4875 18.525C38.603 18.525 42.75 14.3781 42.75 9.26251C42.75 4.14697 38.603 0 33.4875 0C28.3719 0 24.225 4.14697 24.225 9.26251C24.225 14.3781 28.3719 18.525 33.4875 18.525Z\" fill=\"#7B83EB\"/>\n<path d=\"M45.838 21.375H19.712C18.2345 21.4116 17.0657 22.6377 17.1 24.1153V40.5584C16.8937 49.4251 23.9086 56.783 32.775 57C41.6415 56.783 48.6563 49.4251 48.45 40.5584V24.1153C48.4843 22.6377 47.3155 21.4116 45.838 21.375Z\" fill=\"#7B83EB\"/>\n<path opacity=\"0.1\" d=\"M34.2 21.375V44.4173C34.1929 45.4739 33.5526 46.4232 32.5755 46.8255C32.2644 46.9571 31.9301 47.0249 31.5923 47.025H18.354C18.1688 46.5548 17.9978 46.0845 17.8552 45.6C17.3564 43.9649 17.1019 42.265 17.1 40.5555V24.111C17.0657 22.6358 18.2326 21.4116 19.7077 21.375H34.2Z\" fill=\"black\"/>\n<path opacity=\"0.2\" d=\"M32.7751 21.375V45.8422C32.7751 46.18 32.7072 46.5144 32.5756 46.8255C32.1733 47.8026 31.224 48.4429 30.1674 48.45H19.0238C18.7815 47.9797 18.5535 47.5095 18.354 47.025C18.1545 46.5405 17.9978 46.0845 17.8552 45.6C17.3564 43.9649 17.1019 42.265 17.1 40.5555V24.111C17.0657 22.6358 18.2326 21.4116 19.7077 21.375H32.7751Z\" fill=\"black\"/>\n<path opacity=\"0.2\" d=\"M32.7751 21.375V42.9923C32.7643 44.428 31.6031 45.5892 30.1673 45.6H17.8552C17.3564 43.9649 17.1019 42.265 17.1 40.5555V24.111C17.0657 22.6358 18.2326 21.4116 19.7077 21.375H32.7751Z\" fill=\"black\"/>\n<path opacity=\"0.2\" d=\"M31.35 21.375V42.9923C31.3391 44.428 30.1779 45.5892 28.7422 45.6H17.8552C17.3564 43.9649 17.1019 42.265 17.1 40.5555V24.111C17.0657 22.6358 18.2326 21.4116 19.7077 21.375H31.35Z\" fill=\"black\"/>\n<path opacity=\"0.1\" d=\"M34.2 14.0078V18.4966C33.9577 18.5108 33.7297 18.5251 33.4875 18.5251C33.2452 18.5251 33.0172 18.5108 32.7749 18.4966C32.2939 18.4646 31.8169 18.3883 31.35 18.2686C28.4643 17.5852 26.0803 15.5614 24.9375 12.8251C24.7408 12.3655 24.5881 11.8884 24.4814 11.4001H31.5922C33.0302 11.4055 34.1945 12.5698 34.2 14.0078Z\" fill=\"black\"/>\n<path opacity=\"0.2\" d=\"M32.7751 15.4328V18.4965C32.2941 18.4646 31.8171 18.3883 31.3501 18.2685C28.4644 17.5852 26.0804 15.5614 24.9375 12.8251H30.1673C31.6053 12.8305 32.7696 13.9948 32.7751 15.4328Z\" fill=\"black\"/>\n<path opacity=\"0.2\" d=\"M32.7751 15.4328V18.4965C32.2941 18.4646 31.8171 18.3883 31.3501 18.2685C28.4644 17.5852 26.0804 15.5614 24.9375 12.8251H30.1673C31.6053 12.8305 32.7696 13.9948 32.7751 15.4328Z\" fill=\"black\"/>\n<path opacity=\"0.2\" d=\"M31.35 15.4328V18.2685C28.4644 17.5851 26.0804 15.5614 24.9375 12.825H28.7423C30.1802 12.8305 31.3445 13.9948 31.35 15.4328Z\" fill=\"black\"/>\n<path d=\"M2.61201 12.825H28.738C30.1805 12.825 31.35 13.9945 31.35 15.437V41.563C31.35 43.0056 30.1805 44.175 28.738 44.175H2.61201C1.16943 44.175 0 43.0055 0 41.563V15.437C0 13.9945 1.16945 12.825 2.61201 12.825Z\" fill=\"url(#paint0_linear_1279209)\"/>\n<path d=\"M22.5492 22.7686H17.3265V36.9902H13.9992V22.7686H8.80078V20.0098H22.5492V22.7686Z\" fill=\"white\"/>\n</g>\n<defs>\n<linearGradient id=\"paint0_linear_1279209\" x1=\"5.44613\" y1=\"10.784\" x2=\"25.9039\" y2=\"46.216\" gradientUnits=\"userSpaceOnUse\">\n<stop stop-color=\"#5A62C3\"/>\n<stop offset=\"0.5\" stop-color=\"#4D55BD\"/>\n<stop offset=\"1\" stop-color=\"#3940AB\"/>\n</linearGradient>\n<clipPath id=\"clip0_1279209\">\n<rect width=\"61.275\" height=\"57\" fill=\"white\"/>\n</clipPath>\n</defs>\n</svg>\n",
          "version": "5.2.0",
          "description": "Microsoft Teams is the ultimate hub for chat-based collaboration, meetings, calling, and enterprise voice features. \nThis integration allows you to easily build chat bots and messaging extensions for Teams.",
          "tags": {
            ...
            "entities": {
              "microsoftBotFrameworkConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-microsoft-bot-framework-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/microsoft-bot-framework-connector\":\"7.47.8\"}}"
                  },
            ...
            "entities": {
              "pagerdutyConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-pagerduty-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/pagerduty-connector\":\"7.47.8\"}}"
                  },
              ...
              "pagerdutyIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-pagerduty-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/pagerduty-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
        ...
        {
          "id": "pagerduty-discord-bot",
          "name": "PagerDuty Discord Bot",
          "smallIcon": "<svg width=\"100\" height=\"100\" viewBox=\"0 0 100 100\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n<path d=\"M16 73.3671H30.6481V100H16V73.3671ZM71.168 4.88269C63.305 0.697527 57.8516 0 44.9791 0H16V60.6214H44.8523C56.3297 60.6214 64.8903 59.9239 72.4363 54.9144C80.6798 49.461 84.9283 40.3932 84.9283 29.9302C84.9283 18.5796 79.6652 9.51173 71.168 4.88269V4.88269ZM48.2131 47.9391H30.6481V12.9994L47.1985 12.8725C62.2904 12.6823 69.8364 18.0089 69.8364 30.0571C69.8364 42.993 60.5149 47.9391 48.2131 47.9391V47.9391Z\" fill=\"#06AC38\"/>\n</svg>\n\n",
          "largeIcon": "<svg width=\"100\" height=\"100\" viewBox=\"0 0 100 100\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n<path d=\"M16 73.3671H30.6481V100H16V73.3671ZM71.168 4.88269C63.305 0.697527 57.8516 0 44.9791 0H16V60.6214H44.8523C56.3297 60.6214 64.8903 59.9239 72.4363 54.9144C80.6798 49.461 84.9283 40.3932 84.9283 29.9302C84.9283 18.5796 79.6652 9.51173 71.168 4.88269V4.88269ZM48.2131 47.9391H30.6481V12.9994L47.1985 12.8725C62.2904 12.6823 69.8364 18.0089 69.8364 30.0571C69.8364 42.993 60.5149 47.9391 48.2131 47.9391V47.9391Z\" fill=\"#06AC38\"/>\n</svg>\n\n",
          "version": "5.2.0",
            ...
            "entities": {
              "pagerdutyDiscordBotIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-e2e-pagerduty-discord-bot-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/discord-provider\":\"7.47.8\",\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/pagerduty-provider\":\"7.47.8\",\"superagent\":\"^6.1.0\"},\"files\":[\"./integration.js\",\"README.md\"]}",
                    ...
                    "README.md": "This Integration lets you write a custom Discord bot for PagerDuty which uses Slash Commands support to trigger new incidents in PagerDuty.\n\n[Learn more](https://fusebit.io/blog/pagerduty-discord-integration/)!\n"
                  },
                  "handler": "./integration",
                  "components": [
                    {
            ...
            "entities": {
              "quickbooksConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-quickbooks-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/quickbooks-connector\":\"7.47.8\"}}"
                  },
              ...
              "quickbooksIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-quickbooks-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/quickbooks-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
            ...
            "entities": {
              "redditConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-reddit-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/reddit-connector\":\"7.47.8\"}}"
                  },
              ...
              "redditIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-reddit-bot-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/reddit-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
            ...
            "entities": {
              "salesforceConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-salesforce-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/salesforce-connector\":\"7.47.8\"}}"
                  },
              ...
              "salesforceIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-salesforce-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/salesforce-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
            ...
            "entities": {
              ...
              "slackIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-slack-bot-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/slack-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
        ...
        },
        {
          ...
          "resources": {
            "configureAppDocUrl": "https://fusebit.io/blog/slack-crypto-bot/"
          },
          "configuration": {
            "schema": {
              "type": "object",
              "properties": {
                "cryptoSlackBotIntegration": {
                  "type": "object",
                  "properties": {
                    "id": {
                      "type": "string",
                    ...
                    "coinApiKey": {
                      "type": "string",
                      "minLength": 3,
                      "description": "Get API key from https://docs.coinapi.io"
                    }
                  },
                  "required": [
                    "id",
            ...
            "entities": {
              "cryptoSlackBotIntegration": {
                ...
                "data": {
                  "configuration": {
                    "coinApiKey": "<% global.entities.cryptoSlackBotIntegration.coinApiKey %>"
                  },
                  "files": {
                    "package.json": "{\"scripts\":{\"deploy\":\"fuse integration deploy crypto-notification-bot -d .\",\"get\":\"fuse integration get crypto-notification-bot -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/slack-provider\":\"7.47.8\",\"undici\":\"^4.15.1\"},\"files\":[\"./integration.js\",\"README.md\"],\"name\":\"@fusebit-int/catalog-feed-integration-e2e-crypto-slack-bot\",\"version\":\"7.47.8\",\"private\":true}",
            ...
            "entities": {
              "stackoverflowConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-stackoverflow-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/stackoverflow-connector\":\"7.47.8\"}}"
                  },
              ...
              "stackoverflowIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-stackoverflow-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/stackoverflow-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
        ...
        },
        {
          ...
          "largeIcon": "<svg width=\"57\" height=\"57\" viewBox=\"0 0 57 57\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n<path d=\"M51.4336 0H5.56641C2.49217 0 0 2.49217 0 5.56641V51.4336C0 54.5078 2.49217 57 5.56641 57H51.4336C54.5078 57 57 54.5078 57 51.4336V5.56641C57 2.49217 54.5078 0 51.4336 0Z\" fill=\"url(#paint0_linear_133399)\"/>\n<path d=\"M46.918 7.40997H34.8767C33.4011 7.40997 32.2048 8.60621 32.2048 10.0818V29.6756C32.2048 31.1512 33.4011 32.3475 34.8767 32.3475H46.918C48.3936 32.3475 49.5898 31.1512 49.5898 29.6756V10.0818C49.5898 8.60621 48.3936 7.40997 46.918 7.40997Z\" fill=\"white\"/>\n<path d=\"M22.1233 7.40997H10.082C8.6064 7.40997 7.41016 8.60621 7.41016 10.0818V43.9256C7.41016 45.4012 8.6064 46.5975 10.082 46.5975H22.1233C23.5989 46.5975 24.7952 45.4012 24.7952 43.9256V10.0818C24.7952 8.60621 23.5989 7.40997 22.1233 7.40997Z\" fill=\"white\"/>\n<defs>\n<linearGradient id=\"paint0_linear_133399\" x1=\"28.5\" y1=\"0\" x2=\"28.5\" y2=\"57\" gradientUnits=\"userSpaceOnUse\">\n<stop stop-color=\"#0091E6\"/>\n<stop offset=\"1\" stop-color=\"#0079BF\"/>\n</linearGradient>\n</defs>\n</svg>\n",
          "version": "5.2.0",
          "description": "The Trello Integration is extremely powerful and fun to use. Work with Boards, Lists, Cards, Actions to easily \nconnect Trello with your solution. ",
          "outOfPlan": true,
          "tags": {
            "catalog": "Project Management"
          },
        ...
        },
        {
          "id": "twitter",
          "name": "Twitter",
          "smallIcon": "<svg version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\"\n\t viewBox=\"0 0 400 400\" style=\"enable-background:new 0 0 400 400;\" xml:space=\"preserve\">\n<style type=\"text/css\">\n\t.st0{fill:#1B9DF0;}\n\t.st1{fill:#FFFFFF;}\n</style>\n<g id=\"Dark_Blue\">\n\t<circle class=\"st0\" cx=\"200\" cy=\"200\" r=\"200\"/>\n</g>\n<g id=\"Logo__x2014__FIXED\">\n\t<path class=\"st1\" d=\"M163.4,305.5c88.7,0,137.2-73.5,137.2-137.2c0-2.1,0-4.2-0.1-6.2c9.4-6.8,17.6-15.3,24.1-25\n\t\tc-8.6,3.8-17.9,6.4-27.7,7.6c10-6,17.6-15.4,21.2-26.7c-9.3,5.5-19.6,9.5-30.6,11.7c-8.8-9.4-21.3-15.2-35.2-15.2\n\t\tc-26.6,0-48.2,21.6-48.2,48.2c0,3.8,0.4,7.5,1.3,11c-40.1-2-75.6-21.2-99.4-50.4c-4.1,7.1-6.5,15.4-6.5,24.2\n\t\tc0,16.7,8.5,31.5,21.5,40.1c-7.9-0.2-15.3-2.4-21.8-6c0,0.2,0,0.4,0,0.6c0,23.4,16.6,42.8,38.7,47.3c-4,1.1-8.3,1.7-12.7,1.7\n\t\tc-3.1,0-6.1-0.3-9.1-0.9c6.1,19.2,23.9,33.1,45,33.5c-16.5,12.9-37.3,20.6-59.9,20.6c-3.9,0-7.7-0.2-11.5-0.7\n\t\tC110.8,297.5,136.2,305.5,163.4,305.5\"/>\n</g>\n</svg>\n",
          "largeIcon": "<svg viewBox=\"127 90.203 468.624 93.743\" width=\"468.624\" height=\"93.743\">\n\t<g id=\"layer1\" transform=\"matrix(1, 0, 0, 1, 76.539116, 6.642684)\">\n\t\t<g id=\"g4147\" transform=\"translate(394.28571,-405.71429)\">\n\t\t\t<path style=\"fill:#33ccff;fill-opacity:1\" d=\"m -318.57032,582.03156 c -9.12772,-2.45908 -17.50397,-9.39343 -21.78933,-18.03843 -3.28416,-6.62525 -3.28004,-6.57892 -3.2878,-37.02858 -0.38908,-26.33977 -0.24033,-27.18968 1.51554,-29.72998 3.72933,-6.2192 11.95325,-7.54732 17.3452,-2.80113 3.78564,3.33224 4.08657,4.46384 4.08657,15.36697 l 0,9.45539 15.90437,0 c 9.72842,0 16.83068,0.19866 18.28983,0.51158 8.29995,1.78001 11.45075,11.70557 5.688,17.91813 -0.67912,0.73214 -2.07798,1.78616 -3.10858,2.34228 -1.80873,0.97599 -2.47992,1.01608 -19.32372,1.15434 l -17.4499,0.14327 0,4.21672 c 0,6.133 0.63611,8.13956 3.48285,10.9863 3.32424,3.32426 4.21167,3.48083 19.79594,3.49316 12.09042,0.009 13.17784,0.0789 15.13441,0.96448 7.42256,3.35995 9.27173,12.3061 3.79853,18.37701 -3.19923,3.54859 -3.41034,3.58418 -21.13131,3.56395 -13.83162,-0.0157 -16.07961,-0.12201 -18.95061,-0.
 0,4.44033 -2.01752,7.87643 -5.79749,9.87387 -1.77943,0.94033 -2.80131,1.04043 -12.94066,1.26772 -10.513314,0.23569 -11.088164,0.2962 -12.775396,1.3452 -2.227044,1.38461 -3.850817,3.51963 -4.508776,5.92839 -0.308756,1.13032 -0.512883,6.71654 -0.514457,14.07876 -0.0027,12.20195 -0.0027,12.2055 -1.220449,14.64881 -0.822283,1.65008 -1.925391,2.93372 -3.396291,3.9521 -1.912846,1.32437 -2.606832,1.5236 -5.691859,1.63397 -2.760984,0.0987 -3.871894,-0.0692 -5.18735,-0.78397 z M -151.02863,511.01573 c -7.4366,-3.70581 -8.78827,-13.49338 -2.61229,-18.91594 2.40589,-2.11239 4.34144,-2.82489 7.67405,-2.82489 4.66002,0 8.2799,2.17727 10.37289,6.23905 5.00461,9.71218 -5.6264,20.38944 -15.43465,15.50178 z\" id=\"path4223\"></path>\n\t\t</g>\n\t</g>\n</svg>",
          "version": "5.2.0",
          "description": "Integrating with Twitter is easy with Fusebit! This example lets you list the accessible resources in your customer's Twitter account.\n\n[Learn more](https://developer.fusebit.io/docs/twitter)!\n",
          "tags": {
            "catalog": "Social,Community"
          },
          "resources": {
            ...
            "entities": {
              "twitterConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-twitter-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/twitter-connector\":\"7.47.8\"}}"
                  },
              ...
              "twitterIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-twitter-bot-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/twitter-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
        ...
        },
        {
          ...
          "largeIcon": "<svg\n   xmlns:dc=\"http://purl.org/dc/elements/1.1/\"\n   xmlns:cc=\"http://creativecommons.org/ns#\"\n   xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\"\n   xmlns:svg=\"http://www.w3.org/2000/svg\"\n   xmlns=\"http://www.w3.org/2000/svg\"\n   xmlns:sodipodi=\"http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd\"\n   xmlns:inkscape=\"http://www.inkscape.org/namespaces/inkscape\"\n   width=\"786.81995\"\n   height=\"786.81995\"\n   viewBox=\"0 0 208.17944 208.17944\"\n   version=\"1.1\"\n   id=\"svg4443\"\n   inkscape:version=\"0.92.0 r15299\"\n   sodipodi:docname=\"xero.svg\">\n  <defs\n     id=\"defs4437\">\n    <inkscape:perspective\n       id=\"perspective87\"\n       inkscape:persp3d-origin=\"372.04723 : 350.78736 : 1\"\n       inkscape:vp_z=\"744.09449 : 526.18106 : 1\"\n       inkscape:vp_y=\"0 : 999.99994 : 0\"\n       inkscape:vp_x=\"0 : 526.18106 : 1\"\n       sodipodi:type=\"inkscape:persp3d\" />\n    <font\n       font-weight=\"700\"\n       font-style=\"normal\"\n       font-variant=\"normal\"\n       id=\"FontID0\"\n       horiz-origin-x=\"0\"\n       horiz-origin-y=\"0\"\n       horiz-adv-x=\"90\"\n       vert-origin-x=\"45\"\n       vert-origin-y=\"90\"\n       vert-adv-y=\"90\"\n       style=\"font-style:normal;font-variant:normal;font-weight:700\">\n\t<font-face\n   id=\"font-face7\"\n   font-family=\"Arial Narrow\">\n\t</font-face>\n\n   <missing-glyph\n   id=\"missing-glyph9\">\n  <path\n     id=\"path11\"\n     d=\"M0 0z\" />\n</missing-glyph>\n\n   <glyph\n   id=\"glyph13\"\n   horiz-adv-x=\"228\"\n   unicode=\" \" />\n\n   <glyph\n   id=\"glyph15\"\n   horiz-adv-x=\"500\"\n   unicode=\"L\">\n  <path\n     id=\"path17\"\n     d=\"M62.9955 0l0 710 118.173 0 0 -589.33 294.829 0 0 -120.669 -413.002 0z\" />\n</glyph>\n\n   <glyph\n   id=\"glyph19\"\n   horiz-adv-x=\"774\"\n   unicode=\"W\">\n  <path\n     id=\"path21\"\n     d=\"M142.504 0l-140.007 715.836 121.501 0 87.8301 -491.667 107.507 491.667 141.168 0 102.996 -500 90.3377 500 119.158 0 -142.657 -715.836 -126.002 0 -117.165 535.171 -116.169 -535.171 -128.499 0z\" />\n</glyph>\n\n   <glyph\n   id=\"glyph23\"\n   horiz-adv-x=\"456\"\n   unicode=\"k\">\n  <path\n     id=\"path25\"\n     d=\"M55.1662 0l0 715.836 112.829 0 0 -379.834 131.335 182.493 138.671 0 -145.504 -189.326 155.666 -329.169 -120.998 0 -107.496 232.83 -51.6732 -66.828 0 -166.002 -112.829 0z\" />\n</glyph>\n\n   <glyph\n   id=\"glyph27\"\n   horiz-adv-x=\"456\"\n   unicode=\"e\">\n  <path\n     id=\"path29\"\n     d=\"M305.67 164.995l111.833 -22.8308c-15.0015,-52.1659 -38.336,-90.8304 -69.8393,-115.994 -31.6675,-25.3384 -69.9926,-37.8323 -115.161,-37.8323 -62.8312,0 -111.34,20.9912 -145.668,62.9955 -40.3289,48.8371 -60.4989,117.165 -60.4989,204.995 0,86.6694 20.3342,156.005 61.0026,208.007 34.4926,43.9972 79.1577,65.9958 133.831,65.9958 60.8274,0 108.668,-22.5023 143.161,-67.4959 39.6719,-51.3337 59.5024,-127.174 59.5024,-227.498l-0.503701 -15.6695 -281.657 0c0.657001,-40.9969 9.83312,-72.6644 27.4955,-95.1667 17.8376,-22.5023 39.1682,-33.6713 64.1671,-33.6713 36.1679,0 60.3346,24.6704 72.3359,74.1645zm6.32911 138.671c-0.996452,40.3289 -9.66887,70.8357 -25.8311,91.1699 -16.3374,20.3342 -35.6642,30.4958 -58.1665,30.4958 -23.663,0 -43.8329,-10.6653 -60.0061,-31.8317 -16.6659,-21.4949 -24.8237,-51.3337 -24.4952,-89.834l168.499 0z\" />\n</glyph>\n\n   <glyph\n   id=\"glyph31\"\n   horiz-adv-x=\"500\"\n   unicode=\"o\">\n  <path\n     id=\"path33\"\n     d=\"M32.6639 266.666c0,50.6658 10.1726,96.9953 30.3316,138.671 20.1699,41.6648 46.5048,72.8286 79.1687,93.6665 32.4997,20.8269 69.1713,31.328 109.84,31.328 68.3282,0 121.994,-26.8276 161.162,-80.3294 39.004,-53.6661 58.495,-116.169 58.495,-187.837 0,-53.3376 -10.1616,-101.496 -30.4958,-144.497 -20.3342,-43.0007 -46.9975,-75.3362 -80.0009,-96.8311 -33.1676,-21.6701 -69.3356,-32.4997 -108.668,-32.4997 -63.1597,0 -115.665,23.9915 -157.33,72.1607 -41.6648,48.1692 -62
quot;#FontID0&quot;) format(svg)}\n    .fil0 {fill:#28166F}\n    .fnt0 {font-weight:bold;font-size:9.1324;font-family:'Arial Narrow'}\n   \n  </style>\n    <clipPath\n       clipPathUnits=\"userSpaceOnUse\"\n       id=\"clipPath18\">\n      <path\n         d=\"M 0,850.394 H 850.394 V 0 H 0 Z\"\n         id=\"path16\"\n         inkscape:connector-curvature=\"0\" />\n    </clipPath>\n  </defs>\n  <sodipodi:namedview\n     id=\"base\"\n     pagecolor=\"#ffffff\"\n     bordercolor=\"#666666\"\n     borderopacity=\"1.0\"\n     inkscape:pageopacity=\"0.0\"\n     inkscape:pageshadow=\"2\"\n     inkscape:zoom=\"0.68000308\"\n     inkscape:cx=\"391.90999\"\n     inkscape:cy=\"391.90999\"\n     inkscape:document-units=\"mm\"\n     inkscape:current-layer=\"layer1\"\n     showgrid=\"false\"\n     fit-margin-top=\"0\"\n     fit-margin-left=\"0\"\n     fit-margin-right=\"0\"\n     fit-margin-bottom=\"0\"\n     units=\"px\"\n     inkscape:window-width=\"1280\"\n     inkscape:window-height=\"744\"\n     inkscape:window-x=\"-4\"\n     inkscape:window-y=\"-4\"\n     inkscape:window-maximized=\"1\" />\n  <metadata\n     id=\"metadata4440\">\n    <rdf:RDF>\n      <cc:Work\n         rdf:about=\"\">\n        <dc:format>image/svg+xml</dc:format>\n        <dc:type\n           rdf:resource=\"http://purl.org/dc/dcmitype/StillImage\" />\n        <dc:title></dc:title>\n      </cc:Work>\n    </rdf:RDF>\n  </metadata>\n  <g\n     inkscape:label=\"Layer 1\"\n     inkscape:groupmode=\"layer\"\n     id=\"layer1\"\n     transform=\"translate(-5.8874759,-271.69643)\">\n    <g\n       id=\"g10\"\n       transform=\"matrix(0.35277777,0,0,-0.35277777,-39.929542,525.63751)\">\n      <g\n         id=\"g12\">\n        <g\n           id=\"g14\"\n           clip-path=\"url(#clipPath18)\">\n          <path\n             d=\"m 424.933,130.843 c 162.335,0 293.932,131.597 293.932,293.933 0,162.334 -131.597,293.932 -293.932,293.932 C 262.598,718.708 131,587.11 131,424.776 131,262.44 262.598,130.843 424.933,130.843\"\n             style=\"fill:#1ab4d7;fill-opacity:1;fill-rule:nonzero;stroke:none\"\n             id=\"path20\"\n             inkscape:connector-curvature=\"0\" />\n          <path\n             d=\"m 271.701,425.625 50.162,50.286 c 1.663,1.695 2.591,3.939 2.591,6.319 0,4.96 -4.032,8.988 -8.992,8.988 -2.416,0 -4.681,-0.947 -6.389,-2.676 -0.005,-0.01 -50.117,-50.093 -50.117,-50.093 l -50.341,50.168 c -1.701,1.677 -3.955,2.601 -6.345,2.601 -4.954,0 -8.987,-4.026 -8.987,-8.981 0,-2.417 0.965,-4.685 2.697,-6.394 l 50.155,-50.148 -50.129,-50.223 c -1.762,-1.735 -2.723,-4.008 -2.723,-6.436 0,-4.959 4.033,-8.982 8.987,-8.982 2.394,0 4.65,0.929 6.345,2.625 l 50.263,50.195 50.072,-50.012 c 1.776,-1.836 4.067
,18.539 -45.107,31.564 -0.869,2.432 -1.539,4.955 -2.006,7.553 -0.061,0.486 -0.106,0.955 -0.124,1.387 5.405,0 93.812,0.015 93.812,0.015 12.861,0.27 19.783,9.348 17.871,19.729\"\n             style=\"fill:#ffffff;fill-opacity:1;fill-rule:nonzero;stroke:none\"\n             id=\"path30\"\n             inkscape:connector-curvature=\"0\" />\n        </g>\n      </g>\n    </g>\n  </g>\n</svg>\n",
          "version": "5.2.0",
          "description": "Our Xero integration exposes accounting and related functions and can be used for a variety of purposes, from creating transactions like invoices and credit notes, to extracting accounting data.",
          "outOfPlan": true,
          "tags": {
            "catalog": "Accounting"
          },
        ...
        },
        {
          "id": "google-youtube",
          "name": "YouTube",
          "smallIcon": "<svg width=\"159\" height=\"110\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"m154 17.5c-1.82-6.73-7.07-12-13.8-13.8-9.04-3.49-96.6-5.2-122 0.1-6.73 1.82-12 7.07-13.8 13.8-4.08 17.9-4.39 56.6 0.1 74.9 1.82 6.73 7.07 12 13.8 13.8 17.9 4.12 103 4.7 122 0 6.73-1.82 12-7.07 13.8-13.8 4.35-19.5 4.66-55.8-0.1-75z\" fill=\"#f00\"/><path d=\"m105 55-40.8-23.4v46.8z\" fill=\"#fff\"/></svg>\n\n",
          ...
          "version": "5.2.0",
          "description": "This YouTube integration allows you to upload videos, manage playlists and subscriptions, update channel settings, and more.\n\n[Learn more](https://developer.fusebit.io/docs/youtube)!\n",
          "parent": [
            "google"
          ],
          "tags": {
            ...
            "entities": {
              "youtubeConnector": {
                ...
                "data": {
                  "configuration": {
                    ...
                    "scope": "openid profile https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/youtube.readonly",
                    "clientId": "",
                    "clientSecret": "",
                    "refreshErrorLimit": 100000,
                    "refreshInitialBackoff": 100000,
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-youtube-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/google-connector\":\"7.47.8\"}}"
                  },
                  "handler": "@fusebit-int/google-connector"
                },
                "id": "<% this.id %>",
              ...
              "youtubeIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-youtube-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/google-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
        ...
        },
        {
          ...
          "version": "5.2.0",
          "description": "This Integration allows you to access user details, meeting reports, dashboard data, as well as perform actions on the Zoom platform on a user’s behalf, for example, creating a new user or deleting meeting recordings.\n\n[Learn more](https://developer.fusebit.io/docs/zoom)!\n",
          "tags": {
            ...
            "entities": {
              "zoomConnector": {
                ...
                "data": {
                  ...
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-zoom-connector\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"redeploy\":\"fuse connector rm <% this.id %> && yarn deploy\",\"deploy\":\"fuse connector deploy <% this.id %> -d .\",\"get\":\"fuse connector get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/zoom-connector\":\"7.47.8\"}}"
                  },
              ...
              "zoomIntegration": {
                ...
                "data": {
                  "configuration": {},
                  "files": {
                    "package.json": "{\"name\":\"@fusebit-int/catalog-feed-integration-zoom-integration\",\"version\":\"7.47.8\",\"private\":true,\"scripts\":{\"deploy\":\"fuse integration deploy <% this.id %> -d .\",\"get\":\"fuse integration get <% this.id %> -d .\"},\"dependencies\":{\"@fusebit-int/framework\":\"7.47.8\",\"@fusebit-int/zoom-provider\":\"7.47.8\"},\"files\":[\"./integration.js\",\"README.md\"]}",
